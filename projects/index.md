...
#### <span style="color:blue">whole genome sequencing, host switch, evolution, global demography</span>
...
#### <span style="color:blue">host - microbiome, honey bee health, next-generation sequencing, experiments</span>
...
#### <span style="color:blue">double sex, RNAi</span>
...
#### <span style="color:blue">gene expression, transciptomics, venom evolution, complex trait</span>
...
![Gaboon({{ site.url }}{{ site.baseurl }}/images/gaboon.jpg "Snake"){:width="400px"}{: .align-left}
...
#### <span style="color:blue">gene evolution, 'neofunctionalization, venom evolution</span>

![snake({{ site.url }}{{ site.baseurl }}/images/snake.jpg "Snake"){:width="400px"}{: .align-right}
...
#### Key words: spider, silk, materials, proteomics, transcriptomics
